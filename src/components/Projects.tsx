  ...
  const projects = [
    {
      title: "Student-X",
      description:
        "A comprehensive web application for university students featuring buy/sell marketplace, tutoring services, dorm finding, and real-time chatting.",
      tech: [
        "React",
        "Tailwind CSS",
        "JavaScript",
      ...
      hosting:
        "Hostinger (Frontend), Render (Backend), Supabase (Chat & Storage)",
    },
    {
      title: "AI CV Builder",
      description:
        "An intelligent CV builder that creates ATS-optimized professional resumes using OpenAI API integration.",
    ...
    },
    {
      ...
      description:
        "A fully serverless, network-isolated web application on Azure demonstrating enterprise-grade security and scalability.",
      tech: [
        "Azure",
        "App Service",
        "Functions",
    ...
    },
    {
      ...
      description:
        "Complete e-commerce solution for an online toy store with modern frontend and robust backend architecture.",
      tech: ["React", "TypeScript", "C#", "LINQ", "MySQL"],
      category: "E-commerce",
    ...
    },
    {
      ...
      description:
        "Professional frontend website showcasing EFAM's engineering services, company profile, and business portfolio.",
    ...
    },
    {
      ...
      description:
        "Mobile application for finding and booking nearby sports courts with user type-based functionality.",
      tech: ["XML", "Java", "Android Studio", "MySQL"],
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            A showcase of my development work spanning web applications, cloud
            infrastructure, mobile apps, and AI-powered solutions.
          </p>
        </div>
